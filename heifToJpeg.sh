...
echo -e "[~]$greenColour Funcionamiento: sitúate en una carpeta con .heic archivos, automáticamente transforma los archivos a jpeg y los guarda en una carpeta /n"
